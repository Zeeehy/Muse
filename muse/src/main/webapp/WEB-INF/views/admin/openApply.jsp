		...
		<div class="table-content">
			<form class="table-content">
				...
				<div class="buttondiv" style="margin-bottom:50px;margin-top:50px;">
					...
					<input class="blueButton" type="button" value="반영" onclick="window.location.href='openApplyEnd.do?on_code=${dto.on_code}'" style="width: 90px;font-size: 16pt;height: 50px;">
					<input class="grayButton" type="button" value="뒤로가기" onclick="window.location.href='openApplyList.do'" style="margin: 20px; width: 90px;font-size: 16pt;height: 50px;">
