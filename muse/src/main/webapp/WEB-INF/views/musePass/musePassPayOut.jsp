...
$(document).ready(function() {
   ...
   IMP.init('imp12043224');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
      pg : 'html5_inicis', // 결제방식 PG사 구분
       ...
       name : '뮤즈패스 결제',    // {requestScope.order_name}님의 의뢰코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장
